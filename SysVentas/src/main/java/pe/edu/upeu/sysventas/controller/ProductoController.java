...
public class ProductoController {
    ...
    @FXML
    TextField txtNombreProducto, txtPUnit, txtUtilidad, txtStock, txtPUnitOld;
    @FXML
    ...
    @FXML public void initialize(){
        ...
        columns.put("Nombre", new ColumnInfo("nombre",60.0));
    ...
    public void onGuardar(Event e){
        ...
        formulario.setTipoProducto(TipoProducto.valueOf(cbxTipoProducto.getSelectionModel().getSelectedItem().getKey()));
        ...
        formulario.setIdMarca(ms.findById(Long.parseLong(cbxCategoria.getSelectionModel().getSelectedItem().getKey())));
        formulario.setIdUnidad(us.findById(Long.parseLong(cbxCategoria.getSelectionModel().getSelectedItem().getKey())));
